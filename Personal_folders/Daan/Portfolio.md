...
During the minor we learned about several deep learning models, each with its own pros and cons. We encountered some of those models during the guest lectures, other research papers on forecasting energy and during the weekly presentations due to the fact that they were being applied by other project groups. It was decided to focus our research on trying out and comparing those deep learning models.
